...
urlpatterns = [
    ...
    path("register/", views.client_register, name="register"),  # Ajoutez cette ligne
    ...
    # Approvisionnements
    path("approvisionnements/", views.approvisionnements_view, name="approvisionnements"),
    ...
    # Clients (Correction effectuée ici : ajout de name="clients")
    path('clients/', views.gestion_clients, name='clients'),
