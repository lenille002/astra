...
urlpatterns = [
    ...
    path("", views.login_view, name="login"),  # Racine : Connexion par Token (login.html)
    path("connexion/", views.connexion, name="connexion"),  # URL classique : Connexion par mot de passe (connexion.html)
    ...
    path("ventes/details/<int:vente_id>/", views.details_vente, name="details_vente"),
    ...
    path("api/generer-token/", views.generer_token_api, name="generer_token_api"),
